...
public class UserController {
    ...
    public ResponseEntity<?> logout(
        ...
        UserCookieResDto logout = userService.logout(userInfo, accessToken);

        return ResponseEntity.ok().header(HttpHeaders.SET_COOKIE, logout.getDelAccess().toString(), logout.getDelRefresh().toString())
